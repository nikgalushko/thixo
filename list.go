...
func push(list, v interface{}) []interface{} {
...
func mustPush(list, v interface{}) ([]interface{}, error) {
	...
	case reflect.Slice, reflect.Array:
		...
		return append(nl, v), nil // nolint:makezero // falsepositive
...
func prepend(list, v interface{}) []interface{} {
...
func mustPrepend(list, v interface{}) ([]interface{}, error) {
	tp := reflect.TypeOf(list).Kind()
	switch tp {
	case reflect.Slice, reflect.Array:
		l2 := reflect.ValueOf(list)
...
func has(needle, haystack interface{}) bool {
...
func mustHas(needle, haystack interface{}) (bool, error) {
	if haystack == nil {
		return false, nil
	}
